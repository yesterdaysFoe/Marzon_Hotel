 ...
 */
public class DesciptionCellRenderer extends JTextArea implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
        ...
        setFont(new java.awt.Font("Tahoma", Font.ITALIC, 16));
    ...
    private int findTotalMaximumRowSize(JTable table, int row) {
        ...
        while (columns.hasMoreElements()) {
            ...
            if (cellRenderer instanceof DesciptionCellRenderer) {
                DesciptionCellRenderer tar = (DesciptionCellRenderer) cellRenderer;
